...
See `ARCHITECTURE.md` for the product layers and `FEATURE_MATRIX.md` for the current feature inventory.

The original Life Pulse visual system is retained as the base stylesheet; newer features are layered into it rather than replacing the UI wholesale.
